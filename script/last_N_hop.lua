...
---
function last_n_hop_guest_network_distance(iface,send_l3_sock,ip,last_n_hop,trace,VERBOSE)
...
function last_N_hop.last_n_hop_main(dst_ip,last_n_hop,iface,VERBOSE)
	...
	last_n_hop_guest_network_distance(iface,send_l3_sock,dst_ip,last_n_hop,trace,VERBOSE)
