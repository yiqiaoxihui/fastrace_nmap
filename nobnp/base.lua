...
print_tr = function(tr,src_ip,OUTPUT_FILE_HANDLER,OUTPUT_TYPE)
    ...
    if OUTPUT_TYPE == "file" then
	 ...
	 --    OUTPUT_FILE_HANDLER:write(jo,"\n")
		OUTPUT_FILE_HANDLER:write("Target ",tr['dst'] , " hop ",tr['start']," - ",tr['end'] ," from ",src_ip," ",TRR2STRING[tr['rst']+1]," BNP: ",tr['BNP'],"\n")
	end
    io.write("Target ",tr['dst'] , " hop ",tr['start']," - ",tr['end'] ," from ",src_ip," ",TRR2STRING[tr['rst']+1]," BNP: ",tr['BNP'],"\n") 	--加1 table从1开始
